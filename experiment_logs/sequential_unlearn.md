...
| Run | Layers | remove_coef | retain_coef | lr (muon) | Steps | retain_loss | forget_loss | WMDP Bio Robust | MMLU | eff_rank | Notes |
|-----|--------|-------------|-------------|-----------|-------|-------------|-------------|-----------------|------|----------|-------|
| - | - | - | - | - | - | - | - | 0.4297 | 0.4510 | | Baseline |
| 1 | 31→11 (step 4) | 14 | 1 | 0.02 | 768 | ~6.8 | 1.04 | **0.2707** | **0.4160** | | Job 2110810 |
| 2 | 31→11 (step 4) | 5 | 2 | 0.02 | 768 | ~5.9 | 1.07 | **0.3007** | **0.4367** | 2626 | Job 2110867 |
...
| 12 | 31→11 (step 4) | 5 | 2 | 0.02 | 768 | ~5.7 | ~1.04 | **0.2903** | **0.4467** | 2578 | Job 2125986, +regex keyword_mask forget loss |
...
| 16 | 31→0 (step 1) | 5 | 2 | 0.02 | 4096 | | | | | | Job 2126095, +regex keyword_mask, all layers |
